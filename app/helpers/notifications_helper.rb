    ...
    def notification_form(notification)
        ...
        case notification.action
          ...
          when "message" then
              ...
              tag.a(@visitor.name, href:show2_user_path(@visitor), style:"font-weight: bold;")+"から"+tag.a('message', href:"/rooms/#{@visitor.room.id}", style:"font-weight: bold;")+"messageが来ました"
        end
    end
